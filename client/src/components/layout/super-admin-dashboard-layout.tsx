...
export function AdminDashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    },
    {
      ...
      active: location === "/super-admin/white-label",
    },
    {
    ...
    {
      title: "Labels",
      href: "/super-admin/labels",
      icon: <Building2 className="h-5 w-5" />,
      active: location === "/super-admin/labels",
    },
    {
      title: "Statistics",
      href: "/super-admin/statistics",
      icon: <BarChart3 className="h-5 w-5" />,
      active: location === "/super-admin/statistics",
    },
    {
      title: "Settings",
    ...
    },
    {
      ...
      active: location === "/super-admin/system",
    },
  ]
        ...
        >
          ...
          <div className="flex items-center h-16 px-4">
            ...
            >
              ...
              {!collapsed && (
                <span className="text-lg font-bold truncate">MusicDist</span>
              )}
            </Link>
